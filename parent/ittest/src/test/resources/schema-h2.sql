...
ALTER TABLE document.caracteristiques
    ADD CONSTRAINT  IF NOT EXISTS   FK_CARACTERISTIQUES_ON_RESSOURCES FOREIGN KEY (ressources_id) REFERENCES document.ressources (id);

ALTER TABLE document.caracteristiques
    ADD CONSTRAINT  IF NOT EXISTS   FK_CARACTERISTIQUES_ON_ATTRIBUTS FOREIGN KEY (attribut_id) REFERENCES document.attributs (id);
...
ALTER TABLE document.documentspromotions
    ADD CONSTRAINT  IF NOT EXISTS   fk_doc_on_documents_entity FOREIGN KEY (documents_id) REFERENCES document.documents (id);

ALTER TABLE document.documentspromotions
    ADD CONSTRAINT  IF NOT EXISTS   fk_doc_on_promotions_entity FOREIGN KEY (promotions_id) REFERENCES document.promotions (id);

ALTER TABLE document.famillespromotions
    ADD CONSTRAINT  IF NOT EXISTS   fk_fam_on_familles_entity FOREIGN KEY (familles_id) REFERENCES document.familles (id);

ALTER TABLE document.famillespromotions
    ADD CONSTRAINT  IF NOT EXISTS   fk_fam_on_promotions_entity FOREIGN KEY (promotions_id) REFERENCES document.promotions (id);
...
ALTER TABLE document.etapes
    ADD CONSTRAINT  IF NOT EXISTS   FK_ETAPES_ON_PARCOURS FOREIGN KEY (parcours_id) REFERENCES document.parcours (id);
...
ALTER TABLE document.concerner
    ADD CONSTRAINT  IF NOT EXISTS   fk_concerner_on_distributeurs_entity FOREIGN KEY (precomouvementsqtes_id) REFERENCES document.precomouvementsqtes (id);

ALTER TABLE document.concerner
    ADD CONSTRAINT  IF NOT EXISTS   fk_concerner_on_preco_mouvements_qtes_entity FOREIGN KEY (distributeurs_id) REFERENCES document.distributeurs (distributeurs_id);
